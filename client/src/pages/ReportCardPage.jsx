...
const ReportCardPage = ({ studentId }) => {
  ...
  const saveReportCardToCloud = async (studentIdToSave) => {
    ...
    try {
      ...
      const endpoint =
        viewType === "classTest"
          ? `http://localhost:5001/api/students/${studentIdToSave}/class-test-report`
          : `http://localhost:5001/api/students/${studentIdToSave}/report-card`;
  ...
  const handleDeleteUploadedReport = async (studentIdToDelete) => {
    ...
    try {
      ...
      const endpoint =
        viewType === "classTest"
          ? `http://localhost:5001/api/students/${studentIdToDelete}/class-test-report`
          : `http://localhost:5001/api/students/${studentIdToDelete}/report-card`;
