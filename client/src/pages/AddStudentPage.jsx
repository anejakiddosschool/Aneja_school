                ...
                <form onSubmit={handleSubmit}>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div><label htmlFor="dateOfBirth" className={inputLabel}>Date of Birth</label><input id="dateOfBirth" type="date" name="dateOfBirth" value={studentData.dateOfBirth} onChange={handleChange} className={textInput} required /></div>
                         <div><label htmlFor="rollNumber" className={inputLabel}>Roll No</label><input id="rollNumber" type="text" name="rollNumber" value={studentData.rollNumber} onChange={handleChange} className={textInput} required /></div>
                    </div>
                    ...
                    <fieldset className="mt-8 border-t pt-6">
                        <legend className="text-xl font-bold text-gray-700 mb-4">Section Information</legend>
                        <div>
                            <label htmlFor="section" className={inputLabel}>Section</label>
                            <textarea id="section" name="section" value={studentData.section} onChange={handleChange} className={textAreaInput} placeholder="Enter Section Name"/>
                        </div>
                    </fieldset>
                    <div className="mt-8">
