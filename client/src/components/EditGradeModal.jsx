// // src/components/EditGradeModal.js
...
//     setScores(prevScores => ({ ...prevScores, [assessmentTypeId]: newScore }));
//   };
...
//     try {
//       await gradeService.updateGrade(gradeId, { assessments: assessmentsPayload });
//       alert('Grade updated successfully!');
//       onUpdate(); // Refresh grades list in parent
//       onClose();
//     } catch (err) {
...
//         <h2 className="text-xl font-bold mb-4">Edit Grade: {gradeData.subject.name}</h2>
...
const EditGradeModal = ({ gradeId, onClose, onUpdate }) => {
  ...
  // Calculate the current total final score dynamically
