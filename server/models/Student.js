...
//     reportClassTestUrl: { type: String, default: "" },
//     reportClassTestPublicId: { type: String, default: "" },
//     // NEW: store NTSE reports in Cloudinary
//     // STORE only one latest file just like report card
//     reportNTSEUrl: { type: String, default: "" },
//     reportNTSEPublicId: { type: String, default: "" },
...
const studentSchema = new mongoose.Schema(
  {
    ...
    // Main report card (latest file)
    reportCardUrl: { type: String, default: "" },
    reportCardPublicId: { type: String, default: "" },

    // Class Test report (latest file)
    reportClassTestUrl: { type: String, default: "" },
    reportClassTestPublicId: { type: String, default: "" },

    // NTSE report (latest file)
    reportNTSEUrl: { type: String, default: "" },
    reportNTSEPublicId: { type: String, default: "" },

    // Periodic Test report (latest file)
    reportPTUrl: { type: String, default: "" },
    reportPTPublicId: { type: String, default: "" },
