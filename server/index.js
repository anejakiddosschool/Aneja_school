...
// --- 5. Init WhatsApp with socket.io ---
initWhatsApp(io);
...
// --- 8. Serve frontend (React/Vite Build) ---
...
// --- 11. Set socket and online users globally ---
app.set("socketio", io);
app.set("onlineUsers", onlineUsers);
